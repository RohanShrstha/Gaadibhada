...
if(!isset($_SESSION['log_status']))
{
 ...
 if($_SERVER['REQUEST_METHOD']=="POST")
 {
     if(isset($_POST['post']))
     {
         ...
         $sql = "INSERT INTO tbl_vehicles(title,category,brand,type,description,makeyear,engine,transmission,fuel,mileage,doors,seats,features,price,img1,img2,img3,img4,billbookd,insuranced,selfdrive,supplierid) VALUES('$title','$category','$brand','$type',
             '$description','$makeyear','$engine','$transmission','$fuel','$mileage','$doors','$seats','$features','$price','$img1','$img2','$img3','$img4','$billbookd','$insuranced','$selfdrive','$supplierid')";
...
<html>
    <head>
        ...
        <script src="js/validatePost0.js"></script>
            ...
            <div class="form-body">
                ...
                <div class="form">
                    <form action="#" method="post" id="form" enctype="multipart/form-data">
                        ...
                        <div class="content-box">
                            <div class="radiobox">
                                <input type="radio" id="selfdrive" name="self-drive" value="1">Yes
                                <input type="radio" id="selfdrive" name="self-drive" value="0">No
                                <div class="msg"></div>
                            </div>
                        </div>
