...
if(isset($_GET['error']))
{
    echo "alert('Error in deleting file')";
}
 ...
 if($_SERVER['REQUEST_METHOD']=="POST")
 {
     if(isset($_POST['post']))
     {
        ...
        $insuranced = $prevalue['insuranced'];
         ...
         $sql = "UPDATE tbl_vehicles SET title = '$title', brand = '$brand', type = '$type', description = '$description', makeyear = '$makeyear', engine = '$engine', transmission = '$transmission', fuel = '$fuel', mileage = '$mileage', features = '$features', price = '$price', img1 = '$img1', img2 = '$img2', img3 = '$img3', img4 = '$img4', billbookd = '$billbookd', insuranced = '$insuranced', status = 'Updating' WHERE id = '$id'";

        if(mysqli_query($conn,$sql)){
            header('location:mypostview.php?id='.$id.'&category=twowheelers');
        }
        else{
            echo "Failed";
        }
...
<html>
    <head>
        ...
        <script src="js/validateUpdate1.js"></script>
    </head>
    <body>
        <div class="header">
            <?php
                ...
                <div class="form">
                    ...
                    <form action="#" method="post" id="form" enctype="multipart/form-data">
                        ...
                        <div class="buttons">
                            ...
                            <div class="cancel">
                                <input id="button" type="button" value="Cancel" onclick="cancelconfirm()">
                            </div>
                        </div>
                    </form>
                </div>
